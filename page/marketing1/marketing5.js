async function(tahun = '', bulan = ''){
  ...
  $(document).ready(function(){
    $('[pilih-bulan]').change(delay(function(){
      var nilai = $(this).val();
      console.log(nilai);
      location.href = `#/marketing-5/${tahun}/${nilai}`;
    }, 100))
  })
  ...
  var data = `
  {
    ...
    ,"filter":{"key":"data_set","value":"retur"}
    ,"filter2":{"key":"logistik_approve","value":"1"}
    ,"filter3":{"key":"tanggal_permintaan","value":"${tahun}-${bulan}"}
    ,"dataSend":{"data_set":"retur"
    ,"tanggal_permintaan":"${tahun}-${bulan}"}
